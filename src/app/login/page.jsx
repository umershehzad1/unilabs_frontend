...
const router =useRouter()
    ...
    return (
        <Container fluid className="d-flex justify-content-center align-items-center  text-white" style={{ background: "#010B18" }}>
            <Row className="align-items-center justify-content-center w-100" style={{ maxWidth: '600px' }}>
                    ...
                    <Form onSubmit={handleSubmit} style={{ width: '100%' }}>
                        ...
                        <Form className='d-flex flex-md-row flex-column justify-content-between align-items-center mt-3 mb-5'>
                              ...
                              <Form.Check
                                ...
                                />
                        <Link href="/forgetpassword" className="f-of text-white text-decoration-none fw-bold">Forgot Password?</Link>
                        </Form>
